---
title: 'Базовый период в триатлоне'
description:
  'Мой подход к базовому периоду в триатлоне: объём на низком пульсе, зона 2, постепенное наращивание нагрузки. Без
  сложных схем — только проверенное на практике.'
date: 2026-04-03
category: triatlon
---
